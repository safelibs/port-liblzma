...
impl<R: Read> LzmaReader<R> {
    ...
    pub fn new_mem_limit(
        ...
        Self::construct1(reader, uncomp_size, props, dict_size, preset_dict, true)
    }
    ...
    /// Like [`Self::new_with_props`] but requires the range decoder to
    /// reach the finished state once the expected uncompressed size is met.
    pub fn new_with_props_strict(
        reader: R,
        uncomp_size: u64,
        props: u8,
        dict_size: u32,
        ...
        Self::construct1(reader, uncomp_size, props, dict_size, preset_dict, false)
    }
