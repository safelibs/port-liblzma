//! Internal SHA-256 implementation for XZ stream checksums.
...
impl Sha256State {
    ...
    /// Updates the running checksum with additional input.
    ...
    /// Finishes the checksum and returns the digest bytes.
